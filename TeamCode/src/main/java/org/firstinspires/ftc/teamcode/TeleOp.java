...
//    public double intakeTimer;
    ...
    public static int SLIDES_PICKUP = 100;
    public static int SLIDES_SCORE1 = 620;
    public static int SLIDES_SCORE2 = 400;

    public static double armScore = .42;
    public static double armRest = 0.5;
    public static double elbowScore = 0.5;
    public static double elbowRest = 0;
    public static double wristScore = .75;
    public static double wristRest = .59;
...
//        robot.wrist.setPosition(0);
    ...
    public void loop() {
        ...
        telemetry.addData("intakStep", intakeSteps);
        telemetry.update();
