...
@Config
@Autonomous(name = "realBucketAuto")
public class actualBucketAuto extends LinearOpMode {
    ...
    final static Pose2d PICKUP_3 = new Pose2d(-68,-48,Math.toRadians(287));
    ...
    protected void specScore() {
        ...
        builder.splineTo(BUCKET_1.vec(),225);
...
//        sleep(1500);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initialPosition = new Pose2d(-35.5, -60, Math.toRadians(90));
